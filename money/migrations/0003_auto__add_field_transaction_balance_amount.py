...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.balance_amount'
        db.add_column('money_transaction', 'balance_amount',
                      self.gf('core.utils.CurrencyField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Transaction.balance_amount'
        db.delete_column('money_transaction', 'balance_amount')
